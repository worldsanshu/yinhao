  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GestureDetector(
        // 点击空白收起键盘，避免遮挡按钮造成“点不到”的错觉
        onTap: () => FocusScope.of(context).unfocus(),
        child: AbsorbPointer(
          // 仅在真正保存过程中禁用输入，保证按钮除了保存时都可点
          absorbing: _busy,
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  controller: _p1,
                  // 放宽输入：先允许任意字符，保存时再统一过滤数字，避免部分输入法导致无法点击
                ...
                ElevatedButton.icon(
                  ...
                  onPressed: () async {
                    debugPrint('[AppLockSetup] Pressed save');
                    if (mounted) {
